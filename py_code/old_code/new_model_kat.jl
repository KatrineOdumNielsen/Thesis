# =============================================================================
#
#                     Part X: Calculating predicted returns
#
#         
#
# =============================================================================
...
### Calculating mu_hat and theta_i_hat
μ̂ = zeros(3,1)
θ̂ᵢ = zeros(3,1)
...
for j = 3:3
    ...
    elseif abs(θ̂ᵢ[j] - theta_mi) >= 0.00001
        ...
        μ_pot = LinRange(μ̂[j]-0.040,μ̂[j],30)
        ...
        for (i, μ_pot_i) in enumerate(μ_pot)
            try
                ...
                result_low = optimize(θᵢ -> Equation20(θᵢ, μ_pot_i), 0, theta_mi - 0.00000001)
