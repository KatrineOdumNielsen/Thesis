# =============================================================================
#
#                     Part 4D: Finding S_i and zeta_i
#
...
model_data_cgo = pd.read_csv(data_folder + "/preprocessed/model_data_cgo_halves2.csv")
average_metrics = pd.read_csv(data_folder + "/preprocessed/average_metrics_secondhalf.csv")
...
# print(thetas_df)
thetas_df.to_csv(data_folder + '/preprocessed/thetas_df_firsthalf.csv')
...
average_metrics_updated.to_csv(data_folder + '/preprocessed/average_metrics_secondhalf_updated.csv', index=False)
